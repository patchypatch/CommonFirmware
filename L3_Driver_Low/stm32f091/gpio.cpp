...
GPIO_TypeDef* GPIO_array[] = {GPIOA, GPIOB, GPIOC, GPIOD, GPIOE, GPIOF};

uint8_t RCC_AHB_GPIO_Pos_array[] = {RCC_AHBENR_GPIOAEN_Pos, RCC_AHBENR_GPIOBEN_Pos,
	RCC_AHBENR_GPIOCEN_Pos, RCC_AHBENR_GPIODEN_Pos, RCC_AHBENR_GPIOEEN_Pos, RCC_AHBENR_GPIOFEN_Pos};
...
uint8_t GPIO_PUPDR_Pos_array[] = {GPIO_PUPDR_PUPDR0_Pos, GPIO_PUPDR_PUPDR1_Pos, GPIO_PUPDR_PUPDR2_Pos,
	GPIO_PUPDR_PUPDR3_Pos, GPIO_PUPDR_PUPDR4_Pos, GPIO_PUPDR_PUPDR5_Pos, GPIO_PUPDR_PUPDR6_Pos,
	GPIO_PUPDR_PUPDR7_Pos, GPIO_PUPDR_PUPDR8_Pos, GPIO_PUPDR_PUPDR9_Pos, GPIO_PUPDR_PUPDR10_Pos,
	GPIO_PUPDR_PUPDR11_Pos, GPIO_PUPDR_PUPDR12_Pos, GPIO_PUPDR_PUPDR13_Pos, GPIO_PUPDR_PUPDR14_Pos,
...
void gpio_enable_usart(char port, uint8_t pinTx, uint8_t pinRx, uint8_t idxAF) {
	...
	/* Enable GPIO clock */
	RCC->AHBENR |= (1UL << RCC_AHB_GPIO_Pos_array[portIdx]);
	// do two dummy reads after enabling the peripheral clock, as per the errata
	volatile uint32_t dummy;
	dummy = RCC->AHBENR;
	dummy = RCC->AHBENR;
